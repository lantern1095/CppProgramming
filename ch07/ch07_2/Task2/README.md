...
`temp.real = (this->real - op2.real) - (this->img - op2.img);`

- 실수부 연산 결과를 `temp`인 객체의 `real`에 저장

`temp.img = (this->real - op2.img) + (this->img - op2.real);`

- 허수부 연산 결과를 `temp`인 객체의 `img`에 저장
...
## 실행결과
<img width="961" height="98" alt="image" src="https://github.com/user-attachments/assets/76f83232-1c8e-4db1-bc8e-59319ca7c51b" />
